...
def _minimal(**profiles) -> dict:
    ...
    return {
        ...
        "base": {
            ...
            "identity":   {"enabled": False, "dbscan_eps": 0.20,
                           "dbscan_min_samples": 4, "min_split_gap_frames": 3,
                           "merge_enabled": True, "merge_cosine_threshold": 0.10,
            ...
            "pose_motion_sync": {"enabled": False, "velocity_threshold_mps": 1.0,
                                "joint_activity_threshold": 0.10,
                                "knee_amplitude_rad": 0.35, "hip_amplitude_rad": 0.20,
                                "full_speed_mps": 6.0, "strides_per_metre": 0.7},
            "facing_align": {"enabled": False, "velocity_threshold_mps": 1.0,
