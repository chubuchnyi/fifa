...
| **Line thickness as an independent constraint** | Reject, but reformulate | **Agree — and we adopted the reformulation** | Perspective changes thickness without zoom (chicken-and-egg with range). The salvageable version — two line **edges** as parallels at a regulated separation — is adopted as R3 (#95) |
...
- There is a real risk of over-trusting this file. The briefs' **diagnoses** have been better than
  their **prescriptions**: two headline items (R1, R10) were falsified by measurement. Treat the
  remaining adopted items (R3, R5, R7) as hypotheses to measure, not work orders.
