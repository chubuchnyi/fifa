...
> **ARCHIVED 2026-08-07.** A dated snapshot of 2026-06-27 — M1/M2/M3 are all closed and the suite it quotes (480 passed) is four times smaller than today's. Current state is [`../STATUS.md`](../STATUS.md); how to work here is [`../../CLAUDE.md`](../../CLAUDE.md). Kept for provenance only.
